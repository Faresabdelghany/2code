// lib/render-page.tsx
// Shared page-rendering module — extracted from app/page.tsx so that
// both app/page.tsx (home) and app/[slug]/page.tsx can reuse the same logic.
 ...
 * Extracted so it can be called from app/page.tsx (home) and app/[slug]/page.tsx.
 *
 * @param options.showSideDots — when false, SideDots is not rendered (useful for non-home pages)
 */
export function renderPageContent(
  sections: Section[],
  settings: SettingsRow[],
  options: { showSideDots: boolean } = { showSideDots: true },
) {
